...
- pin_list:
  ...
  - {pin_num: L14, peripheral: FLEXIO2, signal: 'IO, 26', pin_signal: GPIO_AD_26, direction: INPUT, pull_up_down_config: Pull_Down}
  - {pin_num: N16, peripheral: FLEXIO2, signal: 'IO, 27', pin_signal: GPIO_AD_27, direction: OUTPUT, pull_up_down_config: Pull_Down}
...
void BOARD_InitPowerStageSPIsPins(void) {
  ...
  IOMUXC_SetPinConfig(
      ...
      0x06U);                                 /* Slew Rate Field: Slow Slew Rate
                                                 ...
                                                 Domain write protection lock: Neither of DWP bits is locked */
  IOMUXC_SetPinConfig(
      IOMUXC_GPIO_AD_27_FLEXIO2_D27,          /* GPIO_AD_27 PAD functional properties : */
      0x06U);                                 /* Slew Rate Field: Slow Slew Rate
                                                 Drive Strength Field: high drive strength
                                                 Pull / Keep Select Field: Pull Enable
                                                 Pull Up / Down Config. Field: Weak pull down
...
- pin_list:
  ...
  - {pin_num: B16, peripheral: USDHC1, signal: usdhc_cmd, pin_signal: GPIO_SD_B1_00, pull_down_pull_up_config: Pull_Up}
  - {pin_num: K16, peripheral: CM7_GPIO3, signal: 'gpio_mux_io_cm7, 31', pin_signal: GPIO_AD_32, direction: INPUT, pull_up_down_config: Pull_Down, pull_keeper_select: no_init}
...
void BOARD_InitSdPins(void) {
  ...
  /* GPIO configuration of SD1_CD_B on GPIO_AD_32 (pin K16) */
  gpio_pin_config_t SD1_CD_B_config = {
      .direction = kGPIO_DigitalInput,
      .outputLogic = 0U,
      .interruptMode = kGPIO_NoIntmode
  };
  /* Initialize GPIO functionality on GPIO_AD_32 (pin K16) */
  GPIO_PinInit(CM7_GPIO3, 31U, &SD1_CD_B_config);
...
- options: {callFromInitBoot: 'true', coreID: cm7, enableClock: 'true'}
- pin_list:
  - {pin_num: F15, peripheral: FLEXSPI1, signal: FLEXSPI_A_DATA0, pin_signal: GPIO_SD_B2_08, pull_down_pull_up_config: No_Pull, pdrv_config: High_Driver}
  - {pin_num: H15, peripheral: FLEXSPI1, signal: FLEXSPI_A_DATA1, pin_signal: GPIO_SD_B2_09, pull_down_pull_up_config: No_Pull}
  - {pin_num: H14, peripheral: FLEXSPI1, signal: FLEXSPI_A_DATA2, pin_signal: GPIO_SD_B2_10, pull_down_pull_up_config: No_Pull}
  - {pin_num: F16, peripheral: FLEXSPI1, signal: FLEXSPI_A_DATA3, pin_signal: GPIO_SD_B2_11, pull_down_pull_up_config: No_Pull}
  - {pin_num: E14, peripheral: FLEXSPI1, signal: FLEXSPI_A_DQS, pin_signal: GPIO_SD_B2_05, pull_down_pull_up_config: Pull_Down}
  - {pin_num: G14, peripheral: FLEXSPI1, signal: FLEXSPI_A_SCLK, pin_signal: GPIO_SD_B2_07, pull_down_pull_up_config: No_Pull}
  - {pin_num: E15, peripheral: FLEXSPI1, signal: FLEXSPI_B_DATA0, pin_signal: GPIO_SD_B2_03, pull_down_pull_up_config: No_Pull}
  - {pin_num: H13, peripheral: FLEXSPI1, signal: FLEXSPI_B_DATA1, pin_signal: GPIO_SD_B2_02, pull_down_pull_up_config: No_Pull}
  - {pin_num: J14, peripheral: FLEXSPI1, signal: FLEXSPI_B_DATA2, pin_signal: GPIO_SD_B2_01, pull_down_pull_up_config: No_Pull}
  - {pin_num: J15, peripheral: FLEXSPI1, signal: FLEXSPI_B_DATA3, pin_signal: GPIO_SD_B2_00, pull_down_pull_up_config: No_Pull}
  - {pin_num: F14, peripheral: FLEXSPI1, signal: FLEXSPI_A_SS1_B, pin_signal: GPIO_SD_B2_04, pull_down_pull_up_config: No_Pull}
  - {pin_num: F17, peripheral: FLEXSPI1, signal: FLEXSPI_A_SS0_B, pin_signal: GPIO_SD_B2_06, pull_down_pull_up_config: No_Pull}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */

/* FUNCTION ************************************************************************************************************
 *
 * Function Name : BOARD_InitLogFlexSPI1Pins, assigned for the Cortex-M7F core.
 * Description   : Configures pin routing and optionally pin electrical features.
 *
 * END ****************************************************************************************************************/
void BOARD_InitLogFlexSPI1Pins(void) {
  CLOCK_EnableClock(kCLOCK_Iomuxc);           /* LPCG on: LPCG is ON. */
  ...
  IOMUXC_SetPinConfig(
      ...
      0x0CU);                                 /* PDRV Field: high drive strength
                                                 ...
                                                 Domain write protection lock: Neither of DWP bits is locked */
  IOMUXC_SetPinConfig(
      IOMUXC_GPIO_SD_B2_04_FLEXSPI1_A_SS1_B,  /* GPIO_SD_B2_04 PAD functional properties : */
      0x0CU);                                 /* PDRV Field: high drive strength
                                                 Pull Down Pull Up Field: No Pull
                                                 Open Drain Field: Disabled
                                                 Domain write protection: Both cores are allowed
...
/* FUNCTION ************************************************************************************************************
 *
 * Function Name : BOARD_InitXipFlexSPI2Pins, assigned for the Cortex-M7F core.
 * Description   : Configures pin routing and optionally pin electrical features.
 *
 * END ****************************************************************************************************************/
void BOARD_InitXipFlexSPI2Pins(void) {
  CLOCK_EnableClock(kCLOCK_Iomuxc);           /* LPCG on: LPCG is ON. */
...
/* FUNCTION ************************************************************************************************************
 *
 * Function Name : BOARD_InitSecureElementPins, assigned for the Cortex-M7F core.
 * Description   : Configures pin routing and optionally pin electrical features.
 *
 * END ****************************************************************************************************************/
void BOARD_InitSecureElementPins(void) {
  CLOCK_EnableClock(kCLOCK_Iomuxc_Lpsr);      /* LPCG on: LPCG is ON. */
