...
#define AT_NONCACHEABLE_OCTALRAM_SECTION_ALIGN_INIT(var, alignbytes) \
    __attribute__((section("NonCacheable_OctalRAM.init"))) var __attribute__((aligned(alignbytes)))
#define AT_NONCACHEABLE_OCTALRAM_SECTION_ALIGN(var, alignbytes) \
    __attribute__((section("NonCacheable_OctalRAM,\"aw\",%nobits @"))) var __attribute__((aligned(alignbytes)))
#else
#define AT_NONCACHEABLE_SECTION(var) var
