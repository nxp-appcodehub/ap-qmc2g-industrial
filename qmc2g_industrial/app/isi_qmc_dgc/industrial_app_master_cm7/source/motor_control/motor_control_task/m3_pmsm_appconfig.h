...
#ifndef M3_PMSM_APPCONFIG_H
#define M3_PMSM_APPCONFIG_H
...
#define M3_U_DCB_OVERVOLTAGE 	(45.0F)  	/* [V], DC bus over voltage threshold */
...
#define M3_ALIGN_DURATION		(uint16_t)(M3_ALIGN_DURATION_TIME * M3_FAST_LOOP_FREQ) /* Must be less than 32767 */
...
#define M3_SPEED_LOOP_HIGH_LIMIT           (7.0F)			/* [A], current output upper limitation */
#define M3_SPEED_LOOP_LOW_LIMIT            (-7.0F)			/* [A], current output lower limitation */
#define M3_CL_SPEED_RAMP			   	   (4000.0F) 		/* [RPM/s], (mechanical) speed accelerating rate during closed-loop */
...
#define M3_QDC_TIMER_FREQUENCY  			(M3_QDC_CLOCK/EXPONENT(2,M3_QDC_TIMER_PRESCALER)) 			/* [Hz], the clock frequency for the timer within QDC */
