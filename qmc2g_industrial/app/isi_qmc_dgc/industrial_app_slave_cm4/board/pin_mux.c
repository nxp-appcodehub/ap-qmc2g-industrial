...
void BOARD_InitBootPins(void) {
    BOARD_InitDebugUartsPins(); // TODO: remove after debug
}
...
- options: {callFromInitBoot: 'true', coreID: cm7, enableClock: 'true'}
- pin_list:
  - {pin_num: N13, peripheral: LPADC1, signal: 'A, 1_0', pin_signal: GPIO_AD_06}
  - {pin_num: R15, peripheral: LPADC1, signal: 'A, 1_1', pin_signal: GPIO_AD_08}
  ...
  - {pin_num: N17, peripheral: LPADC1, signal: 'A, 1_5', pin_signal: GPIO_AD_16}
  - {pin_num: T17, peripheral: LPADC1, signal: 'B, 1_0', pin_signal: GPIO_AD_07}
  - {pin_num: R16, peripheral: LPADC1, signal: 'B, 1_1', pin_signal: GPIO_AD_09}
  ...
  - {pin_num: M14, peripheral: LPADC1, signal: 'B, 1_4', pin_signal: GPIO_AD_15}
  - {pin_num: N15, peripheral: LPADC1, signal: 'B, 1_5', pin_signal: GPIO_AD_17}
  - {pin_num: M16, peripheral: LPADC2, signal: 'A, 2_0', pin_signal: GPIO_AD_18, pull_up_down_config: Pull_Down}
  - {pin_num: K13, peripheral: LPADC2, signal: 'A, 2_1', pin_signal: GPIO_AD_20}
  - {pin_num: K12, peripheral: LPADC2, signal: 'A, 2_2', pin_signal: GPIO_AD_22}
  - {pin_num: P17, peripheral: LPADC2, signal: 'A, 2_3', pin_signal: GPIO_AD_12, identifier: ''}
  - {pin_num: N14, peripheral: LPADC2, signal: 'A, 2_4', pin_signal: GPIO_AD_14, identifier: ''}
  - {pin_num: N17, peripheral: LPADC2, signal: 'A, 2_5', pin_signal: GPIO_AD_16, identifier: ''}
  - {pin_num: L13, peripheral: LPADC2, signal: 'A, 2_6', pin_signal: GPIO_AD_24}
  - {pin_num: L16, peripheral: LPADC2, signal: 'B, 2_0', pin_signal: GPIO_AD_19}
  - {pin_num: K14, peripheral: LPADC2, signal: 'B, 2_1', pin_signal: GPIO_AD_21}
  - {pin_num: J12, peripheral: LPADC2, signal: 'B, 2_2', pin_signal: GPIO_AD_23}
  - {pin_num: L12, peripheral: LPADC2, signal: 'B, 2_3', pin_signal: GPIO_AD_13, identifier: ''}
  - {pin_num: M14, peripheral: LPADC2, signal: 'B, 2_4', pin_signal: GPIO_AD_15, identifier: ''}
  - {pin_num: N15, peripheral: LPADC2, signal: 'B, 2_5', pin_signal: GPIO_AD_17, identifier: ''}
  - {pin_num: M15, peripheral: LPADC2, signal: 'B, 2_6', pin_signal: GPIO_AD_25}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
- pin_list:
  ...
  - {pin_num: N9, peripheral: GPIO13, signal: 'gpio_io, 11', pin_signal: GPIO_SNVS_08}
  - {pin_num: R11, peripheral: GPIO13, signal: 'gpio_io, 12', pin_signal: GPIO_SNVS_09}
  - {pin_num: R5, peripheral: GPIO12, signal: 'gpio_io, 10', pin_signal: GPIO_LPSR_10}
  - {pin_num: T5, peripheral: GPIO12, signal: 'gpio_io, 11', pin_signal: GPIO_LPSR_11}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
- pin_list:
  ...
  - {pin_num: N3, peripheral: GPIO2, signal: 'gpio_mux_io, 28', pin_signal: GPIO_EMC_B2_18, direction: OUTPUT}
  - {pin_num: U5, peripheral: GPIO6, signal: 'gpio_mux_io, 12', pin_signal: GPIO_LPSR_12}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
void BOARD_InitSecureI2cPins(void) {
  ...
  GPIO_PinInit(GPIO12, 3U, &SECURITY_RST_BOOT_MODE1_config);
  ...
  IOMUXC_SetPinMux(
      ...
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinConfig(
      IOMUXC_GPIO_LPSR_03_GPIO12_IO03,        /* GPIO_LPSR_03 PAD functional properties : */
...
- options: {callFromInitBoot: 'true', coreID: cm7, enableClock: 'true'}
- pin_list:
  - {pin_num: D9, peripheral: LPI2C3, signal: SCL, pin_signal: GPIO_DISP_B2_10}
  - {pin_num: A6, peripheral: LPI2C3, signal: SDA, pin_signal: GPIO_DISP_B2_11}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
- options: {callFromInitBoot: 'true', coreID: cm7, enableClock: 'true'}
- pin_list:
  - {pin_num: E8, peripheral: GPIO5, signal: 'gpio_mux_io, 01', pin_signal: GPIO_DISP_B2_00, direction: OUTPUT}
  - {pin_num: F8, peripheral: GPIO5, signal: 'gpio_mux_io, 02', pin_signal: GPIO_DISP_B2_01, direction: OUTPUT}
  - {pin_num: E9, peripheral: GPIO5, signal: 'gpio_mux_io, 03', pin_signal: GPIO_DISP_B2_02, direction: OUTPUT}
  - {pin_num: D7, peripheral: GPIO5, signal: 'gpio_mux_io, 04', pin_signal: GPIO_DISP_B2_03, direction: OUTPUT}
...
- options: {callFromInitBoot: 'true', coreID: cm7, enableClock: 'true'}
- pin_list:
  - {pin_num: J1, peripheral: GPIO2, signal: 'gpio_mux_io, 06', pin_signal: GPIO_EMC_B1_38, direction: INPUT}
  - {pin_num: J2, peripheral: GPIO2, signal: 'gpio_mux_io, 07', pin_signal: GPIO_EMC_B1_39, direction: INPUT}
  - {pin_num: T2, peripheral: GPIO2, signal: 'gpio_mux_io, 27', pin_signal: GPIO_EMC_B2_17, direction: INPUT}
  - {pin_num: H17, peripheral: GPIO4, signal: 'gpio_mux_io, 00', pin_signal: GPIO_AD_33, direction: INPUT}
  - {pin_num: N10, peripheral: GPIO13, signal: 'gpio_io, 07', pin_signal: GPIO_SNVS_04, direction: INPUT}
  - {pin_num: P9, peripheral: GPIO13, signal: 'gpio_io, 08', pin_signal: GPIO_SNVS_05, direction: INPUT}
  - {pin_num: M9, peripheral: GPIO13, signal: 'gpio_io, 09', pin_signal: GPIO_SNVS_06, direction: INPUT}
