...
#define DEBUG_CONSOLE_UART_INDEX 8 /* EVK or EVB, if QMC2G used this must not be used, We expect LPUART8 to be used with DEBUG CONSOLE */
#endif
...
#define FMSTR_UART_INDEX 6 /* EVK or EVB, if QMC2G used this must not be used, We expect LPUART6 to be used with FMSTR */
#endif
...
#define BOARD_SE050_I2C_IRQ_HANDLER 			LPI2C3_IRQHandler
