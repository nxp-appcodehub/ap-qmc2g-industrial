 ...
 */
#define USRMGMT_PAYLOAD_BUFFER_LENGTH  (255)
 ...
 */
#define USRMGMT_MIN_PASSPHRASE_ITERATIONS 2000
 ...
 */
#define WEBSERVICE_HTTPD_ERROR_LOG_INTERVAL 120
