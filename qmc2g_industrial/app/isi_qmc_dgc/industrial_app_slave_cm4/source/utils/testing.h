 ...
 * the applicable license terms, then you may not retain, install, activate or otherwise use the software. The production use license in Section 2.3 is expressly granted for this software.
 */
