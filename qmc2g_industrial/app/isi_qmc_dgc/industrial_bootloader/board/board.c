...
void BOARD_ConfigMPU(void)
{
  ...
  //  MPU->RASR = ARM_MPU_RASR(1, ARM_MPU_AP_NONE, 2, 0, 0, 0, 0, ARM_MPU_REGION_SIZE_4GB);
    ...
    MPU->RBAR = ARM_MPU_RBAR(15, 0x41000000);
    MPU->RASR = ARM_MPU_RASR(0, ARM_MPU_AP_FULL, 2, 0, 0, 0, 0, ARM_MPU_REGION_SIZE_16MB);
...
{
	return (!(GPIO_PinRead(BOARD_USER_BUTTON1_GPIO, BOARD_USER_BUTTON1_GPIO_PIN) |
			 GPIO_PinRead(BOARD_USER_BUTTON2_GPIO, BOARD_USER_BUTTON2_GPIO_PIN) |
			 GPIO_PinRead(BOARD_USER_BUTTON3_GPIO, BOARD_USER_BUTTON3_GPIO_PIN) |
			 GPIO_PinRead(BOARD_USER_BUTTON4_GPIO, BOARD_USER_BUTTON4_GPIO_PIN)));
}
