...
#define BOARD_NAME "MIMXRT1170_QMC2G"

/*! @Brief Debug console configuration */
#ifndef DEBUG_CONSOLE_UART_INDEX
#define DEBUG_CONSOLE_UART_INDEX 6 /* EVK or EVB, if QMC2G used this must not be used, We expect LPUART6 to be used with DEBUG CONSOLE */
#endif
...
#define FMSTR_UART_INDEX 6 /* EVK or EVB, if QMC2G used this must not be used, We expect LPUART8 to be used with FMSTR */
#endif
...
#define BOARD_FMSTR_IRQ            LPUART8_IRQn
#define BOARD_FMSTR_IRQ_HANDLER    LPUART8_IRQHandler
#else
...
#define USER_LED1_ON() GPIO_PortSet(BOARD_USER_LED1_GPIO, 1U << BOARD_USER_LED1_GPIO_PIN) /*!<Turn on target USER_LED1*/
...
#define USER_LED2_ON() GPIO_PortSet(BOARD_USER_LED2_GPIO, 1U << BOARD_USER_LED2_GPIO_PIN) /*!<Turn on target USER_LED2*/
...
#define USER_LED3_ON() GPIO_PortSet(BOARD_USER_LED3_GPIO, 1U << BOARD_USER_LED3_GPIO_PIN) /*!<Turn on target USER_LED3*/
...
#define USER_LED4_ON() GPIO_PortSet(BOARD_USER_LED4_GPIO, 1U << BOARD_USER_LED4_GPIO_PIN) /*!<Turn on target USER_LED4*/
...
#define DIG_OUT_0_INIT(output)                                            \
    GPIO_PinWrite(BOARD_DIG_OUT_0_GPIO, BOARD_DIG_OUT_0_GPIO_PIN, output); \
    BOARD_DIG_OUT_0_GPIO->GDIR |= (1U << BOARD_DIG_OUT_0_GPIO_PIN) 
#define DIG_OUT_0_OFF() \
    GPIO_PortClear(BOARD_DIG_OUT_0_GPIO, 1U << BOARD_DIG_OUT_0_GPIO_PIN)                 
#define DIG_OUT_0_ON() GPIO_PortSet(BOARD_DIG_OUT_0_GPIO, 1U << BOARD_DIG_OUT_0_GPIO_PIN) 
#define DIG_OUT_0_TOGGLE()                                       \
    GPIO_PinWrite(BOARD_DIG_OUT_0_GPIO, BOARD_DIG_OUT_0_GPIO_PIN, \
                  0x1 ^ GPIO_PinRead(BOARD_DIG_OUT_0_GPIO, BOARD_DIG_OUT_0_GPIO_PIN)) 
#define DIG_OUT_1_INIT(output)                                            \
    GPIO_PinWrite(BOARD_DIG_OUT_1_GPIO, BOARD_DIG_OUT_1_GPIO_PIN, output); \
    BOARD_DIG_OUT_1_GPIO->GDIR |= (1U << BOARD_DIG_OUT_1_GPIO_PIN) 
#define DIG_OUT_1_OFF() \
    GPIO_PortClear(BOARD_DIG_OUT_1_GPIO, 1U << BOARD_DIG_OUT_1_GPIO_PIN)                 
#define DIG_OUT_1_ON() GPIO_PortSet(BOARD_DIG_OUT_1_GPIO, 1U << BOARD_DIG_OUT_1_GPIO_PIN) 
#define DIG_OUT_1_TOGGLE()                                       \
    GPIO_PinWrite(BOARD_DIG_OUT_1_GPIO, BOARD_DIG_OUT_1_GPIO_PIN, \
                  0x1 ^ GPIO_PinRead(BOARD_DIG_OUT_1_GPIO, BOARD_DIG_OUT_1_GPIO_PIN)) 				  
#define DIG_OUT_2_INIT(output)                                            \
    GPIO_PinWrite(BOARD_DIG_OUT_2_GPIO, BOARD_DIG_OUT_2_GPIO_PIN, output); \
    BOARD_DIG_OUT_2_GPIO->GDIR |= (1U << BOARD_DIG_OUT_2_GPIO_PIN) 
#define DIG_OUT_2_OFF() \
    GPIO_PortClear(BOARD_DIG_OUT_2_GPIO, 1U << BOARD_DIG_OUT_2_GPIO_PIN)                 
#define DIG_OUT_2_ON() GPIO_PortSet(BOARD_DIG_OUT_2_GPIO, 1U << BOARD_DIG_OUT_2_GPIO_PIN) 
#define DIG_OUT_2_TOGGLE()                                       \
    GPIO_PinWrite(BOARD_DIG_OUT_2_GPIO, BOARD_DIG_OUT_2_GPIO_PIN, \
                  0x1 ^ GPIO_PinRead(BOARD_DIG_OUT_2_GPIO, BOARD_DIG_OUT_2_GPIO_PIN)) 
#define DIG_OUT_3_INIT(output)                                            \
    GPIO_PinWrite(BOARD_DIG_OUT_3_GPIO, BOARD_DIG_OUT_3_GPIO_PIN, output); \
    BOARD_DIG_OUT_3_GPIO->GDIR |= (1U << BOARD_DIG_OUT_3_GPIO_PIN) 
#define DIG_OUT_3_OFF() \
    GPIO_PortClear(BOARD_DIG_OUT_3_GPIO, 1U << BOARD_DIG_OUT_3_GPIO_PIN)                 
#define DIG_OUT_3_ON() GPIO_PortSet(BOARD_DIG_OUT_3_GPIO, 1U << BOARD_DIG_OUT_3_GPIO_PIN) 
#define DIG_OUT_3_TOGGLE()                                       \
    GPIO_PinWrite(BOARD_DIG_OUT_3_GPIO, BOARD_DIG_OUT_3_GPIO_PIN, \
                  0x1 ^ GPIO_PinRead(BOARD_DIG_OUT_3_GPIO, BOARD_DIG_OUT_3_GPIO_PIN)) 
#define SLOW_DIG_OUT_4_INIT(output)                                            \
    GPIO_PinWrite(BOARD_SLOW_DIG_OUT_4_GPIO, BOARD_SLOW_DIG_OUT_4_GPIO_PIN, output); \
    BOARD_SLOW_DIG_OUT_4_GPIO->GDIR |= (1U << BOARD_SLOW_DIG_OUT_4_GPIO_PIN) 
#define SLOW_DIG_OUT_4_OFF() \
    GPIO_PortClear(BOARD_SLOW_DIG_OUT_4_GPIO, 1U << BOARD_SLOW_DIG_OUT_4_GPIO_PIN)                 
#define SLOW_DIG_OUT_4_ON() GPIO_PortSet(BOARD_SLOW_DIG_OUT_4_GPIO, 1U << BOARD_SLOW_DIG_OUT_4_GPIO_PIN) 
#define SLOW_DIG_OUT_4_TOGGLE()                                       \
    GPIO_PinWrite(BOARD_SLOW_DIG_OUT_4_GPIO, BOARD_SLOW_DIG_OUT_4_GPIO_PIN, \
                  0x1 ^ GPIO_PinRead(BOARD_SLOW_DIG_OUT_4_GPIO, BOARD_SLOW_DIG_OUT_4_GPIO_PIN)) 
#define SLOW_DIG_OUT_5_INIT(output)                                            \
    GPIO_PinWrite(BOARD_SLOW_DIG_OUT_5_GPIO, BOARD_SLOW_DIG_OUT_5_GPIO_PIN, output); \
    BOARD_SLOW_DIG_OUT_5_GPIO->GDIR |= (1U << BOARD_SLOW_DIG_OUT_5_GPIO_PIN) 
#define SLOW_DIG_OUT_5_OFF() \
    GPIO_PortClear(BOARD_SLOW_DIG_OUT_5_GPIO, 1U << BOARD_SLOW_DIG_OUT_5_GPIO_PIN)                 
#define SLOW_DIG_OUT_5_ON() GPIO_PortSet(BOARD_SLOW_DIG_OUT_5_GPIO, 1U << BOARD_SLOW_DIG_OUT_5_GPIO_PIN) 
#define SLOW_DIG_OUT_5_TOGGLE()                                       \
    GPIO_PinWrite(BOARD_SLOW_DIG_OUT_5_GPIO, BOARD_SLOW_DIG_OUT_5_GPIO_PIN, \
                  0x1 ^ GPIO_PinRead(BOARD_SLOW_DIG_OUT_5_GPIO, BOARD_SLOW_DIG_OUT_5_GPIO_PIN)) 				  
#define SLOW_DIG_OUT_6_INIT(output)                                            \
    GPIO_PinWrite(BOARD_SLOW_DIG_OUT_6_GPIO, BOARD_SLOW_DIG_OUT_6_GPIO_PIN, output); \
    BOARD_SLOW_DIG_OUT_6_GPIO->GDIR |= (1U << BOARD_SLOW_DIG_OUT_6_GPIO_PIN) 
#define SLOW_DIG_OUT_6_OFF() \
    GPIO_PortClear(BOARD_SLOW_DIG_OUT_6_GPIO, 1U << BOARD_SLOW_DIG_OUT_6_GPIO_PIN)                 
#define SLOW_DIG_OUT_6_ON() GPIO_PortSet(BOARD_SLOW_DIG_OUT_6_GPIO, 1U << BOARD_SLOW_DIG_OUT_6_GPIO_PIN) 
#define SLOW_DIG_OUT_6_TOGGLE()                                       \
    GPIO_PinWrite(BOARD_SLOW_DIG_OUT_6_GPIO, BOARD_SLOW_DIG_OUT_6_GPIO_PIN, \
                  0x1 ^ GPIO_PinRead(BOARD_SLOW_DIG_OUT_6_GPIO, BOARD_SLOW_DIG_OUT_6_GPIO_PIN)) 
#define SLOW_DIG_OUT_7_INIT(output)                                            \
    GPIO_PinWrite(BOARD_SLOW_DIG_OUT_7_GPIO, BOARD_SLOW_DIG_OUT_7_GPIO_PIN, output); \
    BOARD_SLOW_DIG_OUT_7_GPIO->GDIR |= (1U << BOARD_SLOW_DIG_OUT_7_GPIO_PIN) 
#define SLOW_DIG_OUT_7_OFF() \
    GPIO_PortClear(BOARD_SLOW_DIG_OUT_7_GPIO, 1U << BOARD_SLOW_DIG_OUT_7_GPIO_PIN)                 
#define SLOW_DIG_OUT_7_ON() GPIO_PortSet(BOARD_SLOW_DIG_OUT_7_GPIO, 1U << BOARD_SLOW_DIG_OUT_7_GPIO_PIN) 
#define SLOW_DIG_OUT_7_TOGGLE()                                       \
    GPIO_PinWrite(BOARD_SLOW_DIG_OUT_7_GPIO, BOARD_SLOW_DIG_OUT_7_GPIO_PIN, \
                  0x1 ^ GPIO_PinRead(BOARD_SLOW_DIG_OUT_7_GPIO, BOARD_SLOW_DIG_OUT_7_GPIO_PIN)) 
...
#define BOARD_SE050_I2C_CLOCK_SOURCE_SELECT  	(6U)
#define BOARD_SE050_I2C_CLOCK_SOURCE_DIVIDER 	(8U)
#define BOARD_SE050_I2C_CLOCK_ROOT				kCLOCK_Root_Lpi2c3
#define BOARD_SE050_I2C_CLOCK_FREQ           	(CLOCK_GetRootClockFreq(kCLOCK_Root_Lpi2c3))

#define BOARD_SE050_I2C_IRQ         			LPI2C3_IRQn
#define BOARD_SE050_I2C_IRQ_HANDLER 			LPI2C3_IRQHandlerler
