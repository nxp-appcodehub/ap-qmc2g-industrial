...
#   define LPI2C_CLOCK_FREQUENCY BOARD_SE050_I2C_CLOCK_FREQ

#   define AX_I2CM              BOARD_SE050_I2C_BASEADDR
#   define AX_LPI2C_CLK_SRC     LPI2C_CLOCK_FREQUENCY
#   define AX_I2CM_IRQN         BOARD_SE050_I2C_IRQ
#   define USE_LIP2C            BOARD_SE050_I2C_INSTANCE
#endif
