...
call "%CD%"\blhost -t 5242000 %COMPAR% %BLHOST_CONNECT_FLDR% -- write-memory 0x60080000 PATH_TO_YOUR_MCUXPRESSO_WORKSPACE\isi_qmc_dgc_industrial_app_master_cm7\Release_SBL\isi_qmc_dgc_industrial_app_master_cm7.bin 9
